...
if $(".commerce a") {  //used to escape the issue noted in comments on line 9
  return false;
}//end escape if
else {
  $(".scroll a, .navbar-brand, .gototop,.explore").click(function(event){   
    event.preventDefault();
    $('html,body').animate({scrollTop:$(this.hash).offset().top}, 600,'swing'); //this line is causing the issue with the menu link to the ecommerce store being treated as a piece of the original page
